    ...
    <div class="min-h-screen flex items-center justify-center px-4">
      <div class="w-full max-w-md bg-white rounded-2xl shadow-sm border border-slate-100 p-8 text-center fade">
        ...
        <div class="bg-slate-50 rounded-xl p-5 mb-6 text-left">
          <div class="font-medium mb-2">Как оплатить:</div>
          <p class="text-sm text-slate-600">
            Напишите владельцу сервиса или дождитесь, пока он подтвердит оплату.<br><br>
            <span class="text-slate-400">(Здесь позже появится QR-код для оплаты)</span>
          </p>
        </div>
